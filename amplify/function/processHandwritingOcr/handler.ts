...
読取手順：
1. どの行の備考欄または出荷日回答欄のセル内に手書きがあるか特定する
...
- 表の外側、ヘッダー、フッター、余白、欄外メモ、印影付近、ページ上部や下部にある日付は出力しないでください
- 日付を採用してよいのは、表の罫線で区切られた商品行の備考欄または出荷日回答欄のセル内にある場合だけです
- 日付が表の近くに見えても、その行の対象セル内にあると明確に判断できない場合は出力しないでください
